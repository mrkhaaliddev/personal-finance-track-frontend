  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center mx-auto mt-10 w-96">
        <div className="w-[340px]">
          ...
          <saction>
            <form
              ...
              className="flex flex-col mb-3 gap-y-3"
            >
              <div className="relative">
                <User className="absolute bg-white rounded left-2 top-[17px] z-10 w-[16px] h-[16px] text-[#157AFF]" />
                <input
              ...
              <div className="relative">
                <Key className="absolute left-2 top-[15px] z-10 w-[16px] h-[16px] text-[#157AFF]" />
                <input
                  className="relative w-full bg-[#F6F7F9] outline-slate-200 text-sm px-8 py-[12px] rounded-md"
                  type="password"
              ...
              <button
                type="submit"
                className="py-[10px] rounded-md w-full bg-[#157AFF] text-white text-sm"
              >
                Register
              </button>
            </form>
        ...
        <footer className="mt-5 text-xs font-semibold text-slate-400 ">
